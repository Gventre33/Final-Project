...
html.Div(style={'backgroundColor': 'white', 'padding': '20px', 'border': '1px solid #ccc'}, children=[
    html.Div(style={'display': 'flex'}, children=[
        ...
        html.Div([
            ...
            dcc.RadioItems(
                options=[{'label': conference, 'value': conference} for conference in df["NFL Conference"].unique()],
                id='conference-radio'
            ),
...
def update_figure(selected_year, selected_teams,x_axis,y_axis,selected_conference,selected_division):
    ...
    if selected_conference is not None:
    ...
    fig = px.scatter(filtered_df, x=x_axis, y=y_axis,
                     color="NFL Conference", hover_name="Team Name",
                     )
